<?php
/*支持阿里云OSS修改：第0处，引入新建的文件OSSUpload.php*/
require_once(__DIR__.'/OSSUpload.class.php');
/**
...
//        }
        ...
        $obj = $OSSUpload->uploadToAliOSS($file,$this->fullName);
...
//        }
        ...
        $OSSUpload = new OSSUpload();
        $obj = $OSSUpload->uploadToAliOSS($img,$this->fullName);
        if ($obj['status'] == true){
            $this->fullName = $obj['path'];
            $this->stateInfo = $this->stateMap[0];
        }else{
...
//        }
        ...
        $OSSUpload = new OSSUpload();
        $obj = $OSSUpload->uploadToAliOSS($img,$this->fileType);
        if ($obj['status'] == true){
            $this->fullName = $obj['path'];
            $this->stateInfo = $this->stateMap[0];
        }else{
